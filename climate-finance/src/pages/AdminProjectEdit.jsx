      ...
      try {
        ...
        setFormData({
          ...
          wash_component: {
            ...
            water_supply_percent: project.wash_component?.water_supply_percent || 0,
            sanitation_percent: project.wash_component?.sanitation_percent || 0,
            public_admin_percent: project.wash_component?.public_admin_percent || 0
          }
        });
      } catch (err) {
    ...
    <PageLayout bgColor="bg-gray-50">
      ...
      <Card padding={true}>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Updated Form Sections with improved components */}
          <ProjectFormSections
            formData={formData}
