        ...
        <div className="p-4 border-b border-gray-100">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              {/* Type Filter */}
              <select
                className="block w-full sm:w-auto border border-gray-300 rounded-md text-sm py-2 px-3"
                value={selectedType}
            ...
            <div key={source.id} className="p-4">
              <div className="flex flex-col md:flex-row md:items-center">
                ...
                <div className="flex flex-wrap md:ml-auto">
                  ...
                  <a href="#" className="text-primary text-sm flex items-center mt-4 md:mt-0 md:ml-4">
                    View Details
